...
public class RestaurantEntity implements Serializable{
    ...
    private static final long serialVersionUIDd = -7453430021123563729L;
    public String logo = "";//商戶logo
    public String name= "";//商戶名稱
    public int rate_numbers= 0;//星星數量
    public String buy_nums= "";//售出數量
    public String item_msg= "";//商戶信息
    public String promotion= "";//商戶推廣信息
    public Boolean is_rest= false;//商戶是否休息
    public Boolean is_favor= false;//是否添加關注
    public Boolean is_half= false;//是否半價
    public Boolean is_mins= false;//是否減價
